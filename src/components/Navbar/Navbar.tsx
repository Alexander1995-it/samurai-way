    ...
    return (
        <div className={style.navbar__block}>
            <div className={style.navbar__content}>
                ...
                <NavLink activeClassName={style.navbar__activeLink} className={style.navbar__link} to='friends'>
                    <div className={style.navbar__profile + ' ' + style.navbar__text}>Friends</div>
                </NavLink>
